...
class ProductFeaturesModel extends Model
{
    ...
    protected $fillable = ['product_feature_id', 'product_feature_name', 'product_feature_title', 'product_feature_details', 'created_by_id', 'created_date_time', 'last_updated_by_id', 'last_updated_date_time', 'product_feature_remarks'];
