            ...
            <div class="container mt-5">
                <table class="table table-stripped" id="table">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="col-12">
                                <a href="{{route('addingProduct')}}"><input name="product_name" type="" value="Add Product" class="btn btn-primary float-right"></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <tr>
                        ...
                        @foreach ($products as $product)
                            ...
                            <td class="d-flex">
                                <i class="btn fa fa-trash text-white bg-danger delete mr-2" data-id=""></i>
