...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <form id="submit-items" method="post" action="{{route('adonItem')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control col-md-4" name="adon_item_price" id="adon_item_price"><br>
                                    ...
                                    <button type="submit" id="submit-item" name="addItem" class="btn-success rounded">Add Item</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <table class="table table-stripped" id="table">
                ...
                <tr>
                    ...
                    $sr=1;
                    ?>
                    @foreach ($adon_items as $item)
                        <td>{{$sr++}}</td>
                    <td><img class="img-fluid" src="{{asset($item->adon_item_image)}}" ></td>
                        <td>{{$item->adon_item_name}}</td>
                         <td>{{$item->adon_id}}</td>
                          <td>{{$item->adon_item_price}}</td>
                          <td>{{$item->adon_item_updated_at}}</td>
                          <td>{{$item->adon_item_created_at}}</td>

                        <td class="d-flex">

                            <form method="post" action="{{route('delete.adonItem',['id'=>$item->adon_item_id])}}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                @method('DELETE')
                                <button class="bg-danger rounded mr-2"><i class="btn fa fa-trash text-white bg-danger delete"></i></button>
                            </form>
                             <a href="{{route('edit.adonItem',['id'=>$item->adon_item_id])}}"><button class="bg-success rounded"> <i class="btn fa fa-pencil text-white bg-success edit"></i></button></a>
                        </td>
