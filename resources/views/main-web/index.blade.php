                                    ...
                                    <div class="block-content">
                                        <div class="policy-item">
                                            <div class="policy-content iconpolicy1">
                                                <img src="{{asset('storage/img/home/home1-policy.png')}}" alt="img">
                                    ...
                                    <div class="block-content">
                                        <div class="policy-item">
                                            <div class="policy-content iconpolicy2">
                                                <img src="{{asset('storage/img/home/home1-policy2.png')}}" alt="img">
                                    ...
                                    <div class="block-content">
                                        <div class="policy-item">
                                            <div class="policy-content iconpolicy3">
                                                <img src="{{asset('storage/img/home/home1-policy3.png')}}" alt="img">
                                                            ...
                                                            <ul class="menu level1">
                                                                @foreach ($categories as $category)
                                                                    <li class="item parent">
                                                                        <a href="#" class="hasicon" title="{{ $category->category_name }}">
                                                                            <img src="{{asset('storage/img/home/table-lamp.png')}}" alt="img">{{ $category->category_name }}</a>
                                        ...
                                        <div class="tab-content">
                                            <div id="new" class="tab-pane fade in active show">
                                                <div class="category-product-index owl-carousel owl-theme owl-loaded owl-drag">
                                                    @foreach($categories as $category)
                                                        @php
                                                            $grouped_products = $category->products->groupBy('product_title');
                                                        @endphp
                                                        @foreach($grouped_products as $product_title => $products)
                                                            @php
                                                                ...
                                                                <div class="product-miniature first-item js-product-miniature item-one">
                                                                    <div class="thumbnail-container">
                                                                        ...
                                                                        <a href="{{ route('product.detail', ['id' => $product->product_id]) }}">
                                                                            <img class="img-fluid image-cover" src="{{asset($product->product_front_image)}}" alt="img">
                                                                    ...
                                                                    <div class="product-description">
                                                                        <div class="product-groups">
                                                                            <div class="product-title">
                                                                                <a href="/product-detail">{{$product->product_title}}</a>
                                                                            </div>
                                                                            <div class="rating">
                                            ...
                                            <div class="tab-pane fade" id="best">
                                                        ...
                                                        @foreach($grouped_products as $product_title => $products)
                                                            ...
                                                            <div class="item text-center">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="{{ route('product.detail', ['id' => $product->product_id]) }}">
                                                                            <img class="img-fluid image-cover" src="{{asset('/storage/img/'.$product->product_front_image)}}" alt="img">
                                                                        </a>
                                                                        <div class="product-flags discount">-30%</div>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/5.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/12.jpg')}}" alt="img">
                                                            </a>
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/6.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/13.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                            ...
                                            <div class="category-product-index owl-carousel owl-theme">
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/7.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/14.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="product-flags discount">-30%</div>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/8.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/15.jpg')}}" alt="img">
                                                            </a>
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/9.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/16.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="product-flags discount">-20%</div>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
            ...
            <div class="section spacing-10 group-image-special col-lg-12 col-xs-12">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="effect">
                            <a href="#">
                                <img class="img-fluid" src="{{asset('storage/img/home/effect1.jpg')}}" alt="banner-1" title="banner-1">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="effect">
                            <a href="#">
                                <img class="img-fluid" src="{{asset('storage/img/home/effect2.jpg')}}" alt="banner-2" title="banner-2">
                            </a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="category-product-index owl-carousel owl-theme owl-loaded owl-drag">
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/26.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/1.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/25.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/2.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/10.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/9.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/3.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/9.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/24.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/3.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/23.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/4.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                            ...
                                            <div class="category-product-index owl-carousel owl-theme owl-loaded owl-drag">
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/10.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/11.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="product-flags discount">-10%</div>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/16.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/14.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                            ...
                                            <div class="category-product-index owl-carousel owl-theme">
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/4.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/12.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="product-flags discount">-10%</div>
                                                            <div class="highlighted-informations">
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/13.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/6.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                            ...
                                            <div class="category-product-index owl-carousel owl-theme">
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/10.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/8.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="product-flags discount">-30%</div>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('storage/img/product/11.jpg')}}" alt="img">
                                                                <img class="img-fluid image-secondary" src="{{asset('storage/img/product/14.jpg')}}" alt="img">
                                                            </a>
                                                            <div class="product-flags discount">-20%</div>
                                                            <div class="highlighted-informations">
            ...
            <div class="section spacing-10 group-image-special col-lg-12 col-xs-12">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="effect">
                            <a href="#">
                                <img class="img-fluid" src="{{asset('storage/img/home/effect3.jpg')}}" alt="banner-1" title="banner-1">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="effect">
                            <a href="#">
                                <img class="img-fluid" src="{{asset('storage/img/home/effect4.jpg')}}" alt="banner-2" title="banner-2">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="items col-lg-12 col-sm-12 col-xs-12">
                            <div class="tiva-content-lookbook">
                                <img class="img-fluid img-responsive" src="{{asset('storage/img/home/home1-tolltip1.jpg')}}" alt="lookbook">
                                    ...
                                    <div class="content-lookbook">
                                        <div class="main-lookbook d-flex align-items-center">
                                            <div class="item-thumb">
                                                <a href="/product-detail">
                                                    <img src="{{asset('storage/img/home/icon-tolltip2.jpg')}}" alt="lorem-ipsum-dolor-sit-amet">
                                                </a>
                                            </div>
                                ...
                                <div class="item-lookbook item2">
                                    ...
                                    <div class="content-lookbook">
                                        <div class="main-lookbook  d-flex align-items-center">
                                            <div class="item-thumb">
                                                <a href="/product-detail">
                                                    <img src="{{asset('storage/img/home/icon-tolltip1.jpg')}}" alt="contrary-to-popular-belief">
                                                </a>
                                            </div>
                                            <div class="content-bottom">
                                                <div class="item-title">
                ...
                <div class="tiva-lookbook default  col-lg-6 col-md-6 col-xs-12">
                    <div class="row">
                        <div class="items col-lg-12 col-sm-12 col-xs-12">
                            <div class="tiva-content-lookbook">
                                <img class="img-fluid img-responsive" src="{{asset('storage/img/home/home1-tolltip2.jpg')}}" alt="lookbook">
                                ...
                                <div class="item-lookbook item3">
                                    ...
                                    <div class="content-lookbook">
                                        <div class="main-lookbook  d-flex align-items-center">
                                            <div class="item-thumb">
                                                <a href="/product-detail">
                                                    <img src="{{asset('storage/img/product/34.jpg')}}" alt="lorem-ipsum-dolor-sit-amet">
                                                </a>
                                            </div>
                                            <div class="content-bottom">
                                                <div class="item-title">
                                ...
                                <div class="item-lookbook item4">
                                    ...
                                    <div class="content-lookbook">
                                        <div class="main-lookbook  d-flex align-items-center">
                                            <div class="item-thumb">
                                                <a href="/product-detail">
                                                    <img src="{{asset('storage/img/home/icon-tolltip6.jpg')}}" alt="lorem-ipsum-dolor-sit-amet">
                                                </a>
                                            </div>
                                            <div class="content-bottom">
                                                <div class="item-title">
                                ...
                                <div class="item-lookbook item5">
                                    ...
                                    <div class="content-lookbook">
                                        <div class="main-lookbook  d-flex align-items-center">
                                            <div class="item-thumb">
                                                <a href="/product-detail">
                                                    <img src="{{asset('storage/img/home/icon-tolltip4.jpg')}}" alt="mug-the-adventure-begins">
                                                </a>
                                            </div>
                                            <div class="content-bottom">
                                                <div class="item-title">
                ...
                <div class="tiva-lookbook default  col-lg-6 col-md-6 col-xs-12">
                    <div class="row">
                        <div class="items col-lg-12 col-sm-12 col-xs-12">
                            <div class="tiva-content-lookbook">
                                <img class="img-fluid img-responsive" src="{{asset('storage/img/home/home1-tolltip3.jpg')}}" alt="lookbook">
                                ...
                                <div class="item-lookbook item7">
                                    ...
                                    <div class="content-lookbook">
                                        <div class="main-lookbook  d-flex align-items-center">
                                            <div class="item-thumb">
                                                <a href="/product-detail">
                                                    <img src="{{asset('storage/img/product/13.jpg')}}" alt="brown-bear-vector-graphics">
                                                </a>
                                            </div>
                                            <div class="content-bottom">
                                                <div class="item-title">
                ...
                <div class="tiva-lookbook default  col-lg-6 col-md-6 col-xs-12">
                    <div class="row">
                        <div class="items col-lg-12 col-sm-12 col-xs-12">
                            <div class="tiva-content-lookbook">
                                <img class="img-fluid img-responsive" src="{{asset('storage/img/home/home1-tolltip4.jpg')}}" alt="lookbook">
                                ...
                                <div class="item-lookbook item9">
                                    ...
                                    <div class="content-lookbook">
                                        <div class="main-lookbook  d-flex align-items-center">
                                            <div class="item-thumb">
                                                <a href="/product-detail">
                                                    <img src="{{asset('storage/img/home/icon-tolltip10.jpg')}}" alt="lorem-ipsum-dolor-sit-amet">
                                                </a>
                                            </div>
                                            <div class="content-bottom">
                                                <div class="item-title">
                                ...
                                <div class="item-lookbook item10">
                                    ...
                                    <div class="content-lookbook">
                                        <div class="main-lookbook  d-flex align-items-center">
                                            <div class="item-thumb">
                                                <a href="/product-detail">
                                                    <img src="{{asset('storage/img/home/icon-tolltip8.jpg')}}" alt="lorem-ipsum-dolor-sit-amet">
                                                </a>
                                            </div>
                                            <div class="content-bottom">
                                                <div class="item-title">
                                                    <a href="/product-detail">Donec accumsan lectus ut</a>
                                                </div>
                                                <div class="rating">
                                                    <div class="star-content">
                                                        <div class="star"></div>
                                ...
                                <div class="item-lookbook item11">
                                    ...
                                    <div class="content-lookbook">
                                        <div class="main-lookbook  d-flex align-items-center">
                                            <div class="item-thumb">
                                                <a href="/product-detail">
                                                    <img src="{{asset('storage/img/home/icon-tolltip9.jpg')}}" alt="lorem-ipsum-dolor-sit-amet">
                                                </a>
                                            </div>
                                            <div class="content-bottom">
                                                <div class="item-title">
                                                    <a href="/product-detail">Fusce quis felis libero</a>
                                                </div>
                                                <div class="rating">
                                                    <div class="star-content">
                                                        <div class="star"></div>
                ...
                <div class="row">
                        ...
                        <div class="item-post">
                            <div class="thumbnail-img">
                                <a href="blog-detail.html">
                                    <img src="{{asset('storage/img/home/home1-post1.jpg')}}" alt="img">
                                </a>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="item-post">
                            <div class="thumbnail-img">
                                <a href="blog-detail.html">
                                    <img src="{{asset('storage/img/home/home1-post2.jpg')}}" alt="img">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-info">
                    ...
                    <div class="col-md-4">
                        <div class="item-post">
                            <div class="thumbnail-img">
                                <a href="blog-detail.html">
                                    <img src="{{asset('storage/img/home/home1-post3.jpg')}}" alt="img">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-info">
                                ...
                                <div class="item">
                                    <div class="logo-manu">
                                        <a href="#" title="view products">
                                            <img class="img-fluid" src="{{asset('storage/img/home/icon-logo1.jpg')}}" alt="img" />
                                        </a>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="logo-manu">
                                        <a href="#" title="view products">
                                            <img class="img-fluid" src="{{asset('storage/img/home/icon-logo2.jpg')}}" alt="img" />
                                        </a>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="logo-manu">
                                        <a href="#" title="view products">
                                            <img class="img-fluid" src="{{asset('storage/img/home/icon-logo3.jpg')}}" alt="img" />
                                        </a>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="logo-manu">
                                        <a href="#" title="view products">
                                            <img class="img-fluid" src="{{asset('storage/img/home/icon-logo4.jpg')}}" alt="img" />
                                        </a>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="logo-manu">
                                        <a href="#" title="view products">
                                            <img class="img-fluid" src="{{asset('storage/img/home/icon-logo5.jpg')}}" alt="img" />
                                        </a>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="logo-manu">
                                        <a href="#" title="view products">
                                            <img class="img-fluid" src="{{asset('storage/img/home/icon-logo6.jpg')}}" alt="img" />
                                        </a>
                                    </div>
                                </div>
                            </div>
