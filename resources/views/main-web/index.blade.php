                                                                    ...
                                                                    @foreach ($categories as $category)
                                                                        <li class="item parent">
                                                                            <a href="#" class="hasicon" title="{{ $category->category_name }}">
                                                                                <img src="{{asset('img/home/table-lamp.png')}}" alt="="img">{{ $category->category_name }}</a>
                                                        ...
                                                        <div class="category-product-index owl-carousel owl-theme owl-loaded owl-drag">
                                                            @foreach($categories as $category)
                                                                ...
                                                                @foreach($grouped_products as $product_title => $products)
                                                                    ...
                                                                    @endphp                                                                      <div class="item text-center">
                                                                            <div class="product-miniature first-item js-product-miniature item-one">
                                                                                <div class="thumbnail-container">
                                                                                    <a href="{{ route('product.detail', ['id' => $product->product_id]) }}">
                                                                                        <img class="img-fluid image-cover" src="{{ asset($product->product_front_image) }}" alt="="{{ $product->product_title }}">
                                                                                    </a>
                                                                                    <div class="product-flags wishlist discount">
                                                                                        <a class="addToWishlist" href="#" data-rel="" onclick="">
                                                                                ...
                                                                                <div class="product-buttons justify-content-center">
                                                                                    <form action="#" method="post" class="formAddToCart">
                                                                                        <a class="add-to-cart-btn btn-outline-danger" href="#" data-button-action="add-to-cart">
                                                                                            <p class="bg-danger rounded text-white">ADD TO CART</p>
                                                                                        </a>
                                                                                    </form>
                                                                                    <a href="#" class="quick-view1 hidden-sm-down" data-link-action="quickview">
                                                                                        <p class="bg-success rounded text-white">Quick View</p>
                                                                                    </a>
                                                                                </div>
                                                                ...
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid image-cover" src="{{asset('img/product/4.jpg')}}" alt="="img">
                                                                            <img class="img-fluid image-secondary" src="{{asset('img/product/10.jpg')}}" alt="="img">
                                                                        </a>
                                                                ...
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            ...
                                                                            <img class="img-fluid image-secondary" src="{{asset('img/product/13.jpg')}}" alt="="img">
                                                                        </a>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                                                                                <a href="#" class="color beige" title="Beige"></a>
                                                        ...
                                                        <div class="category-product-index owl-carousel owl-theme">
                                                            <div class="item text-center">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid image-cover" src="{{asset('img/product/7.jpg')}}" alt="="img">
                                                                ...
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            ...
                                                                            <img class="img-fluid image-secondary" src="{{asset('img/product/15.jpg')}}" alt="="img">
                                                                        </a>
                                                            ...
                                                            <div class="item text-center">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid image-cover" src="{{asset('img/product/9.jpg')}}" alt="="img">
                                                                            <img class="img-fluid image-secondary" src="{{asset('img/product/16.jpg')}}" alt="="img">
                                                                        </a>
                                                                        <div class="product-flags discount">-20%</div>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                            ...
                            <div class="section spacing-10 group-image-special col-lg-12 col-xs-12">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="effect">
                                            <a href="#">
                                                <img class="img-fluid" src="{{asset('img/home/effect1.jpg')}}" alt="="banner-1" title="banner-1">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="effect">
                                            <a href="#">
                                                <img class="img-fluid" src="{{asset('img/home/effect2.jpg')}}" alt="="banner-2" title="banner-2">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row d-flex align-items-center">
                                                ...
                                                <div class="flex-4 col-lg-4 flex-4">
                                                    ...
                                                    <div class="content-text">
                                                        ...
                                                        <div>
                                                            <a href="/product-grid-sidebar-left"> View all product </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="category-product-index owl-carousel owl-theme owl-loaded owl-drag">
                                                                <div class="item text-center">
                                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                                        <div class="thumbnail-container">
                                                                            <a href="/product-detail">
                                                                                ...
                                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/1.jpg')}}" alt="="img">
                                                                            </a>
                                                                            <div class="highlighted-informations">
                                                                                <div class="variant-links">
                                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                                    ...
                                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                                        <div class="thumbnail-container">
                                                                            <a href="/product-detail">
                                                                                <img class="img-fluid image-cover" src="{{asset('img/product/25.jpg')}}" alt="="img">
                                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/2.jpg')}}" alt="="img">
                                                                            </a>
                                                                            <div class="highlighted-informations">
                                                                                <div class="variant-links">
                                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                                    ...
                                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                                        <div class="thumbnail-container">
                                                                            <a href="/product-detail">
                                                                                ...
                                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/9.jpg')}}" alt="="img">
                                                                            </a>
                                                                            <div class="highlighted-informations">
                                                                                <div class="variant-links">
                                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                                ...
                                                                <div class="item text-center">
                                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                                        <div class="thumbnail-container">
                                                                            <a href="/product-detail">
                                                                                <img class="img-fluid image-cover" src="{{asset('img/product/24.jpg')}}" alt="="img">
                                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/3.jpg')}}" alt="="img">
                                                                            </a>
                                                                            <div class="highlighted-informations">
                                                                                <div class="variant-links">
                                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                                    ...
                                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                                        <div class="thumbnail-container">
                                                                            <a href="/product-detail">
                                                                                <img class="img-fluid image-cover" src="{{asset('img/product/23.jpg')}}" alt="="img">
                                                ...
                                                <div class="categoriestab-right col-lg-3 align-items-start d-flex flex-column col-md-3 flex-3">
                                                    ...
                                                    <div class="cate-child-vertical">
                                                        <ul class="d-flex align-items-start flex-column">
                                                            ...
                                                            <li>
                                                                <a href="/product-grid-sidebar-left">Colander</a>
                                                            </li>
                                                            <li>
                                                                <a href="/product-grid-sidebar-left">Mixing Bowls</a>
                                                            </li>
                                                            <li>
                                                                <a href="/product-grid-sidebar-left">Grater</a>
                                                            </li>
                                                            <li>
                                                                <a href="/product-grid-sidebar-left">Vegetable Peeler</a>
                                                            </li>
                                                            <li>
                                                                <a href="/product-grid-sidebar-left">Rolling Pin</a>
                                                            </li>
                                                            <li>
                                                                <a href="/product-grid-sidebar-left">Baking Sheet</a>
                                                            </li>
                                                            <li>
                                                                <a href="/product-grid-sidebar-left">Oven Mitts</a>
                                                            </li>
                                                            <li>
                                                                <a href="/product-grid-sidebar-left">Dutch Oven</a>
                                                            </li>
                                                            <li>
                                                                <a href="/product-grid-sidebar-left">Salad Bowl</a>
                                                            </li>
                                                            <li>
                                                                <a href="/product-grid-sidebar-left">WINDOW</a>
                                                            </li>
                                                                    ...
                                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                                        <div class="thumbnail-container">
                                                                            <a href="/product-detail">
                                                                                ...
                                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/6.jpg')}}" alt="="img">
                                                                            </a>
                                                                            <div class="highlighted-informations">
                                                                                <div class="variant-links">
                                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                                ...
                                                                <div class="item text-center">
                                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                                        <div class="thumbnail-container">
                                                                            <a href="/product-detail">
                                                                                <img class="img-fluid image-cover" src="{{asset('img/product/10.jpg')}}" alt="="img">
                                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/8.jpg')}}" alt="="img">
                                                                            </a>
                                                                            <div class="product-flags discount">-30%</div>
                                                                            <div class="highlighted-informations">
                                                                                <div class="variant-links">
                            ...
                            <div class="section spacing-10 group-image-special col-lg-12 col-xs-12">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="effect">
                                            <a href="#">
                                                <img class="img-fluid" src="{{asset('img/home/effect3.jpg')}}" alt="="banner-1" title="banner-1">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="effect">
                                            <a href="#">
                                                <img class="img-fluid" src="{{asset('img/home/effect4.jpg')}}" alt="="banner-2" title="banner-2">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="items col-lg-12 col-sm-12 col-xs-12">
                                            <div class="tiva-content-lookbook">
                                                <img class="img-fluid img-responsive" src="{{asset('img/home/home1-tolltip1.jpg')}}" alt="="lookbook">
                                                    ...
                                                    <div class="content-lookbook">
                                                        <div class="main-lookbook d-flex align-items-center">
                                                            <div class="item-thumb">
                                                                <a href="/product-detail">
                                                                    <img src="{{asset('img/home/icon-tolltip2.jpg')}}" alt="="lorem-ipsum-dolor-sit-amet">
                                                                </a>
                                                            </div>
                                                ...
                                                <div class="item-lookbook item2">
                                                    ...
                                                    <div class="content-lookbook">
                                                        <div class="main-lookbook  d-flex align-items-center">
                                                            <div class="item-thumb">
                                                                <a href="/product-detail">
                                                                    <img src="{{asset('img/home/icon-tolltip1.jpg')}}" alt="="contrary-to-popular-belief">
                                                                </a>
                                                            </div>
                                                            <div class="content-bottom">
                                                                <div class="item-title">
                                ...
                                <div class="tiva-lookbook default  col-lg-6 col-md-6 col-xs-12">
                                    <div class="row">
                                        <div class="items col-lg-12 col-sm-12 col-xs-12">
                                            <div class="tiva-content-lookbook">
                                                <img class="img-fluid img-responsive" src="{{asset('img/home/home1-tolltip2.jpg')}}" alt="="lookbook">
												...
												<div class="item-lookbook item3">
                                                    ...
                                                    <div class="content-lookbook">
                                                        <div class="main-lookbook  d-flex align-items-center">
                                                            <div class="item-thumb">
                                                                <a href="/product-detail">
                                                                    <img src="{{asset('img/product/34.jpg')}}" alt="="lorem-ipsum-dolor-sit-amet">
                                                                </a>
                                                            </div>
                                                            <div class="content-bottom">
                                                                <div class="item-title">
                                                ...
                                                <div class="item-lookbook item4">
                                                    ...
                                                    <div class="content-lookbook">
                                                        <div class="main-lookbook  d-flex align-items-center">
                                                            <div class="item-thumb">
                                                                <a href="/product-detail">
                                                                    <img src="{{asset('img/home/icon-tolltip6.jpg')}}" alt="="lorem-ipsum-dolor-sit-amet">
                                                                </a>
                                                            </div>
                                                            <div class="content-bottom">
                                                                <div class="item-title">
                                                ...
                                                <div class="item-lookbook item5">
                                                    ...
                                                    <div class="content-lookbook">
                                                        <div class="main-lookbook  d-flex align-items-center">
                                                            <div class="item-thumb">
                                                                <a href="/product-detail">
                                                                    <img src="{{asset('img/home/icon-tolltip4.jpg')}}" alt="="mug-the-adventure-begins">
                                                                </a>
                                                            </div>
                                                            <div class="content-bottom">
                                                                <div class="item-title">
                                ...
                                <div class="tiva-lookbook default  col-lg-6 col-md-6 col-xs-12">
                                    <div class="row">
                                        <div class="items col-lg-12 col-sm-12 col-xs-12">
                                            <div class="tiva-content-lookbook">
                                                <img class="img-fluid img-responsive" src="{{asset('img/home/home1-tolltip3.jpg')}}" alt="="lookbook">
                                ...
                                <div class="tiva-lookbook default  col-lg-6 col-md-6 col-xs-12">
                                    <div class="row">
                                        <div class="items col-lg-12 col-sm-12 col-xs-12">
                                            <div class="tiva-content-lookbook">
                                                <img class="img-fluid img-responsive" src="{{asset('img/home/home1-tolltip4.jpg')}}" alt="="lookbook">
												...
												<div class="item-lookbook item9">
                                                    ...
                                                    <div class="content-lookbook">
                                                        <div class="main-lookbook  d-flex align-items-center">
                                                            <div class="item-thumb">
                                                                <a href="/product-detail">
                                                                    <img src="{{asset('img/home/icon-tolltip10.jpg')}}" alt="="lorem-ipsum-dolor-sit-amet">
                                                                </a>
                                                            </div>
                                                            <div class="content-bottom">
                                                                <div class="item-title">
                                                                ...
                                                                <div class="readmore">
                                                                    <a href="{{asset('/product-detail')}}">View More</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="item-lookbook item10">
                                                    ...
                                                    <div class="content-lookbook">
                                                        <div class="main-lookbook  d-flex align-items-center">
                                                            <div class="item-thumb">
                                                                <a href="/product-detail">
                                                                    <img src="{{asset('img/home/icon-tolltip8.jpg')}}" alt="="lorem-ipsum-dolor-sit-amet">
                                                                </a>
                                                            </div>
                                                            <div class="content-bottom">
                                                                <div class="item-title">
                                                ...
                                                <div class="item-lookbook item11">
                                                    ...
                                                    <div class="content-lookbook">
                                                        <div class="main-lookbook  d-flex align-items-center">
                                                            <div class="item-thumb">
                                                                <a href="/product-detail">
                                                                    <img src="{{asset('img/home/icon-tolltip9.jpg')}}" alt="="lorem-ipsum-dolor-sit-amet">
                                                                </a>
                                                            </div>
                                                            <div class="content-bottom">
                                                                <div class="item-title">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="item-post">
                                            <div class="thumbnail-img">
                                                <a href="/blog-detail">
                                                    <img src="{{asset('img/home/home1-post1.jpg')}}" alt="="img">
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="item-post">
                                            <div class="thumbnail-img">
                                                <a href="/blog-detail">
                                                    <img src="{{asset('img/home/home1-post2.jpg')}}" alt="="img">
                                                </a>
                                            </div>
                                            <div class="post-content">
                                                <div class="post-info">
                                    ...
                                    <div class="col-md-4">
                                        <div class="item-post">
                                            <div class="thumbnail-img">
                                                <a href="/blog-detail">
                                                    <img src="{{asset('img/home/home1-post3.jpg')}}" alt="="img">
                                                </a>
                                            </div>
                                            <div class="post-content">
                                                <div class="post-info">
                                                ...
                                                <div class="item">
                                                    <div class="logo-manu">
                                                        <a href="#" title="view products">
                                                            <img class="img-fluid" src="{{asset('img/home/icon-logo1.jpg')}}" alt="="img" />
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="item">
                                                    <div class="logo-manu">
                                                        <a href="#" title="view products">
                                                            <img class="img-fluid" src="{{asset('img/home/icon-logo2.jpg')}}" alt="="img" />
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="item">
                                                    <div class="logo-manu">
                                                        <a href="#" title="view products">
                                                            <img class="img-fluid" src="{{asset('img/home/icon-logo3.jpg')}}" alt="="img" />
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="item">
                                                    <div class="logo-manu">
                                                        <a href="#" title="view products">
                                                            <img class="img-fluid" src="{{asset('img/home/icon-logo4.jpg')}}" alt="="img" />
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="item">
                                                    <div class="logo-manu">
                                                        <a href="#" title="view products">
                                                            <img class="img-fluid" src="{{asset('img/home/icon-logo5.jpg')}}" alt="="img" />
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="item">
                                                    <div class="logo-manu">
                                                        <a href="#" title="view products">
                                                            <img class="img-fluid" src="{{asset('img/home/icon-logo6.jpg')}}" alt="="img" />
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
