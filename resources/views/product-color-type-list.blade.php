                ...
                <table class="table table-stripped" id="table">
                    ...
                    <tr>
                        ...
                        @foreach ($color_type_list as $color_type)
                            <td>{{$sr++}}</td>
                            <td>{{ $color_type->colour_type_name }}</td>
                            <td>{{ $color_type->created_at}}</td>
                            <td>{{ $color_type->created_by_id }}</td>
                            <td>{{$color_type->updated_at }}</td>
                            <td>{{ $color_type->updated_by_id }}</td>
                            <td>
                                <i class="btn fa fa-trash text-white bg-danger delete" data-id=""></i>
