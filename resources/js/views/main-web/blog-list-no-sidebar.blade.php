...
<body id="blog-full-width" class="blog">
    <header>
        <!-- header left mobie -->
                ...
                <div id="main">
                    <div class="page-home">
                        ...
                        <div class="container">
                            <div class="content">
                                <div class="row">
                                    <div class="col main-blogs text-center">
                                        <h2>Recent Posts</h2>
                                        <div>
                                            <div class="hover-after">
                                                <a href="/blog-detail">
                                                    <img src="{{asset('storage/img/blog/1.jpg')}}" alt= "">img" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="late-item">
                                                ...
                                                <p class="description">Proin gravida nibh vel velit auctor aliquet. Aenean sollicudin, lorem quis
                                                    ...
                                                    nibh vultate cursus a sit amet mauris ...
                                        ...
                                        <div>
                                            <div class="hover-after">
                                                <a href="/blog-detail">
                                                    <img src="{{asset('storage/img/blog/2.jpg')}}" alt= "">img" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="late-item">
                                                <p class="content-title">
                                        ...
                                        <div>
                                            <div class="hover-after">
                                                <a href="/blog-detail">
                                                    <img src="{{asset('storage/img/blog/3.jpg')}}" alt= "">img" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="late-item">
                                                <p class="content-title">
