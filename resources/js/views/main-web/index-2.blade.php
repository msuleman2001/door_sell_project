                                                            ...
                                                            @foreach ($categories as $category)
                                                                <li class="item parent">
                                                                    <a href="#" class="hasicon" title="{{ $category->category_name }}">
                                                                        <img src="{{asset('img/home/table-lamp.png')}}" alt= "">{{ $category->category_name }}</a>
                                                                ...
                                                                <div class="product-miniature first-item js-product-miniature item-one">
                                                                    <div class="thumbnail-container">
                                                                        <a href="{{ route('product.detail', ['id' => $product->product_id]) }}">
                                                                            <img class="img-fluid image-cover" src="{{$product->product_front_image}}" alt= "">{{ $product->product_title }}">
                                                                        </a>
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('img/product/4.jpg')}}" alt= "">
                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/10.jpg')}}" alt= "">
                                                            </a>
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                ...
                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/13.jpg')}}" alt= "">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                            ...
                                            <div class="category-product-index owl-carousel owl-theme">
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('img/product/7.jpg')}}" alt= "">
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                ...
                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/15.jpg')}}" alt= "">
                                                            </a>
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('img/product/9.jpg')}}" alt= "">
                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/16.jpg')}}" alt= "">
                                                            </a>
                                                            <div class="product-flags discount">-20%</div>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
            ...
            <div class="section spacing-10 group-image-special col-lg-12 col-xs-12">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="effect">
                            <a href="#">
                                <img class="img-fluid" src="{{asset('img/home/effect1.jpg')}}" alt= ""> title="banner-1">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="effect">
                            <a href="#">
                                <img class="img-fluid" src="{{asset('img/home/effect2.jpg')}}" alt= ""> title="banner-2">
                            </a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="category-product-index owl-carousel owl-theme owl-loaded owl-drag">
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                ...
                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/1.jpg')}}" alt= "">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                ...
                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/2.jpg')}}" alt= "">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                ...
                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/9.jpg')}}" alt= "">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('img/product/24.jpg')}}" alt= "">
                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/3.jpg')}}" alt= "">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('img/product/23.jpg')}}" alt= "">
                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/4.jpg')}}" alt= "">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                    ...
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                ...
                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/6.jpg')}}" alt= "">
                                                            </a>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
                                                                    <a href="#" class="color beige" title="Beige"></a>
                                                ...
                                                <div class="item text-center">
                                                    <div class="product-miniature js-product-miniature item-one first-item">
                                                        <div class="thumbnail-container">
                                                            <a href="/product-detail">
                                                                <img class="img-fluid image-cover" src="{{asset('img/product/10.jpg')}}" alt= "">
                                                                <img class="img-fluid image-secondary" src="{{asset('img/product/8.jpg')}}" alt= "">
                                                            </a>
                                                            <div class="product-flags discount">-30%</div>
                                                            <div class="highlighted-informations">
                                                                <div class="variant-links">
            ...
            <div class="section spacing-10 group-image-special col-lg-12 col-xs-12">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="effect">
                            <a href="#">
                                <img class="img-fluid" src="{{asset('img/home/effect3.jpg')}}" alt= ""> title="banner-1">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="effect">
                            <a href="#">
                                <img class="img-fluid" src="{{asset('img/home/effect4.jpg')}}" alt= ""> title="banner-2">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="item-post">
                            <div class="thumbnail-img">
                                <a href="/blog-detail">
                                    <img src="{{asset('img/home/home1-post1.jpg')}}" alt= "">
                                </a>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="item-post">
                            <div class="thumbnail-img">
                                <a href="/blog-detail">
                                    <img src="{{asset('img/home/home1-post2.jpg')}}" alt= "">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-info">
                    ...
                    <div class="col-md-4">
                        <div class="item-post">
                            <div class="thumbnail-img">
                                <a href="/blog-detail">
                                    <img src="{{asset('img/home/home1-post3.jpg')}}" alt= "">
                                </a>
                            </div>
                            <div class="post-content">
                                <div class="post-info">
