													...
													<div class="item-lookbook item3">
                                                        ...
                                                        <div class="content-lookbook">
                                                            <div class="main-lookbook d-flex align-items-center">
                                                                <div class="item-thumb">
                                                                    <a href="/product-detail">
                                                                        <img src="{{asset('img/home/icon-tolltip5.jpg')}}" alt= "">lorem-ipsum-dolor-sit-amet">
                                                                    </a>
                                                                </div>
                                                                <div class="content-bottom">
                                                                    <div class="item-title">
                                                        ...
                                                        <div class="item text-center row">
                                                            ...
                                                            <div class="col-md-3 col-xs-12">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid" src="{{asset('img/product/9.jpg')}}" alt= "">
                                                                        </a>
                                                                        <div class="product-flags discount">-10%</div>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                                                            ...
                                                            <div class="col-md-3 col-xs-12">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid" src="{{asset('img/product/17.jpg')}}" alt= "">
                                                                        </a>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                                                                                <a href="#" class="color beige" title="Beige"></a>
                                                            ...
                                                            <div class="col-md-3 col-xs-12">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid" src="{{asset('img/product/13.jpg')}}" alt= "">
                                                                        </a>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                                                                                <a href="#" class="color beige" title="Beige"></a>
                                                            ...
                                                            <div class="col-md-3 col-xs-12">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid" src="{{asset('img/product/26.jpg')}}" alt= "">
                                                                        </a>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                                                                                <a href="#" class="color beige" title="Beige"></a>
                                                        ...
                                                        <div class="item text-center row">
                                                            ...
                                                            <div class="col-md-3 col-xs-12">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid" src="{{asset('img/product/6.jpg')}}" alt= "">
                                                                        </a>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                                                                                <a href="#" class="color beige" title="Beige"></a>
                                                            ...
                                                            <div class="col-md-3 col-xs-12">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid" src="{{asset('img/product/7.jpg')}}" alt= "">
                                                                        </a>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
																				<a href="#" class="color beige" title="Beige"></a>
                                                            ...
                                                            <div class="col-md-3 col-xs-12">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid" src="{{asset('img/product/8.jpg')}}" alt= "">
                                                                        </a>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                                                                                <a href="#" class="color beige" title="Beige"></a>
                                                        ...
                                                        <div class="item text-center row">
                                                            ...
                                                            <div class="col-md-3 col-xs-12">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid" src="{{asset('img/product/11.jpg')}}" alt= "">
                                                            ...
                                                            <div class="col-md-3 col-xs-12">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid" src="{{asset('img/product/12.jpg')}}" alt= "">
                                                                        </a>
                                                                        <div class="product-flags discount">-10%</div>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                                                            ...
                                                            <div class="col-md-3 col-xs-12">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid" src="{{asset('img/product/14.jpg')}}" alt= "">
                                                                        </a>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                                                                                <a href="#" class="color beige" title="Beige"></a>
                                                            ...
                                                            <div class="col-md-3 col-xs-12">
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container">
                                                                        <a href="/product-detail">
                                                                            <img class="img-fluid" src="{{asset('img/product/15.jpg')}}" alt= "">
                                                                        </a>
                                                                        <div class="highlighted-informations">
                                                                            <div class="variant-links">
                                                                                <a href="#" class="color beige" title="Beige"></a>
                        ...
                        <div class="section spacing-10 group-image-special">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 banner1">
                                    <div class="effect">
                                        <a href="#">
                                            <img class="img-fluid width-100" src="{{asset('img/home/effect5.jpg')}}" alt= ""> title="banner-1">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 banner1">
                                    <div class="effect">
                                        <a href="#">
                                            <img class="img-fluid width-100" src="{{asset('img/home/effect6.jpg')}}" alt= ""> title="banner-2">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 banner1">
                                    <div class="effect">
                                        <a href="#">
                                            <img class="img-fluid width-100" src="{{asset('img/home/effect7.jpg')}}" alt= ""> title="banner-2">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 banner1">
                                    <div class="effect">
                                        <a href="#">
                                            <img class="img-fluid width-100" src="{{asset('img/home/effect8.jpg')}}" alt= ""> title="banner-2">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 banner1">
                                    <div class="effect">
                                        <a href="#">
                                            <img class="img-fluid width-100" src="{{asset('img/home/effect9.jpg')}}" alt= ""> title="banner-2">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="category-product owl-carousel owl-theme owl-loaded owl-drag">
                                                ...
                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                    <div class="thumbnail-container">
                                                        <a href="/product-detail">
                                                            ...
                                                            <img class="img-fluid image-secondary" src="{{asset('img/product/24.jpg')}}" alt= "">
                                                        </a>
                                                        <div class="product-flags discount">-30%</div>
                                                    </div>
                                                    <div class="product-description">
                                            ...
                                            <div class="item text-center">
                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                    <div class="thumbnail-container">
                                                        <a href="/product-detail">
                                                            <img class="img-fluid image-cover" src="{{asset('img/product/12.jpg')}}" alt= "">
                                                            <img class="img-fluid image-secondary" src="{{asset('img/product/4.jpg')}}" alt= "">
                                                        </a>
                                                    </div>
                                                    <div class="product-description">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 align-items-center justify-content-md-end justify-content-sm-center d-flex pb-xs-max-20 flex-center">
                        <img src="{{asset('img/home/payment.jpg')}}" alt= "">
                    </div>
                </div>
            </div>
        </div>
