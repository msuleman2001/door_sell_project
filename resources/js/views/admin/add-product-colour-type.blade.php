...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <form method="post" action="{{route('addedColourType')}}">
                @csrf
                <div class="form-group">
                    <label for="color-type-name">Color Type Name</label>
                    <input type="text" class="form-control col-md-6" id="colour-type-name" name="colour_type_name" placeholder="Enter color type name">
                </div>
                <div class="form-group">
